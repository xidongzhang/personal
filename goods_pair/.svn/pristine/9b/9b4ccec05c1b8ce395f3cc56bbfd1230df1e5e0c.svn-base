...
{    
    ...
    #round 3: 
    $HADOOP_HOME/bin/hadoop jar $HADOOP_HOME/contrib/streaming/hadoop-streaming-1.2.2-SNAPSHOT.jar \
    -input $HDFS_HOME/fea_data/test_$1_comb_fea -input $HDFS_HOME/$3_train_data/round.two/final/part-* \
    -output $HDFS_HOME/$1_$2_data/round.three \
    -mapper ./round3.map.py -file ./round3.map.py \
    -jobconf stream.num.map.output.key.fields=2 \
    -partitioner org.apache.hadoop.mapred.lib.KeyFieldBasedPartitioner \
...
round_four ()
{
    ...
    #round 4: 
    $HADOOP_HOME/bin/hadoop jar $HADOOP_HOME/contrib/streaming/hadoop-streaming-1.2.2-SNAPSHOT.jar \
    -input $HDFS_HOME/fea_data/test_$1_comb_fea -input $HDFS_HOME/$1_$2_data/round.three/part-* \
...
round_three $sign1 $sign2 $sign3
round_four $sign1 $sign2 $sign3
