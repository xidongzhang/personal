...
HDFS_HOME="/user/ml/personal_online_new"
...
round_two_mapred ()
{
    ...
    $HADOOP_HOME/bin/hadoop jar $HADOOP_HOME/contrib/streaming/hadoop-streaming-1.2.2-SNAPSHOT.jar \
    -input /user/chongweishen/personal/ctr_common_train/data_filt \
    -output $HDFS_HOME/$1_data/round.two \
    -mapper ./round2.map1.py -reducer "./round2.red2.py $colLimit"\
...
round_three ()
{    
    $HADOOP_HOME/bin/hadoop fs -rmr ./$1_data/round.three
    #round 3: 
    $HADOOP_HOME/bin/hadoop jar $HADOOP_HOME/contrib/streaming/hadoop-streaming-1.2.2-SNAPSHOT.jar \
    -input $HDFS_HOME/$1_data/round.one/part-* -input $HDFS_HOME/round.two/final/part-* \
...
{    
    ...
    #round 3: 
    $HADOOP_HOME/bin/hadoop jar $HADOOP_HOME/contrib/streaming/hadoop-streaming-1.2.2-SNAPSHOT.jar \
    -input /user/chongweishen/personal/ctr_common_train/data_filt -input $HDFS_HOME/$1_data/round.two/final/part-* \
    -output $HDFS_HOME/$1_data/round.three \
    -mapper ./round3.map.py -file ./round3.map.py \
    -jobconf stream.num.map.output.key.fields=2 \
    -partitioner org.apache.hadoop.mapred.lib.KeyFieldBasedPartitioner \
...
round_four ()
{
    ...
    #round 4: 
    $HADOOP_HOME/bin/hadoop jar $HADOOP_HOME/contrib/streaming/hadoop-streaming-1.2.2-SNAPSHOT.jar \
    -input /user/chongweishen/personal/ctr_common_train/data_filt -input $HDFS_HOME/$1_data/round.three/part-* \
...
round_five ()
{
    ...
    -input $HDFS_HOME/$1_data/round.four/part-* \
    -output $HDFS_HOME/$1_data/round.five \
    -mapper ./round5.map.py -file ./round5.map.py \
    -reducer "./round5.red.py $rowLimit" -file ./round5.red.py \
