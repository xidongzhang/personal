...
{    
    ...
    #round 3: 
    $HADOOP_HOME/bin/hadoop jar $HADOOP_HOME/contrib/streaming/hadoop-streaming-1.2.2-SNAPSHOT.jar \
    -input $HDFS_HOME/ctr2_common_$sign/data_filt -input $HDFS_HOME/"$trainSign"_data/round.two/final/* \
...
round_four ()
{
    ...
    #round 4: 
    $HADOOP_HOME/bin/hadoop jar $HADOOP_HOME/contrib/streaming/hadoop-streaming-1.2.2-SNAPSHOT.jar \
    -input $HDFS_HOME/ctr2_common_$sign/data_filt -input $HDFS_HOME/$1_data/round.three/part-* \
