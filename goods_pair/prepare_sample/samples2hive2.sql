...
insert overwrite table tmp.collocations_samples partition(sample_type='negative',hash_uid=${hash_uid})
select
...
--=================================================================
insert overwrite table tmp.collocations_samples partition(sample_type='positive',hash_uid=${hash_uid})
	select
	t1.twitter_id as tid1,t2.twitter_id as tid2,sum(1) as num 
	from
	(select user_id,twitter_id,md5query
