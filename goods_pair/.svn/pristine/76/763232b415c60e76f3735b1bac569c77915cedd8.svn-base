...
HDFS_HOME="/user/ml/personal_dev"
...
round_two_mapred ()
{
    ...
    $HADOOP_HOME/bin/hadoop jar $HADOOP_HOME/contrib/streaming/hadoop-streaming-1.2.2-SNAPSHOT.jar \
    -input /user/chongweishen/personal/ctr_sample_train/data_filt \
    -output $HDFS_HOME/$1_data/round.two \
...
{    
    ...
    #round 3: 
    $HADOOP_HOME/bin/hadoop jar $HADOOP_HOME/contrib/streaming/hadoop-streaming-1.2.2-SNAPSHOT.jar \
    -input /user/chongweishen/personal/ctr_sample_train/data_filt -input $HDFS_HOME/$1_data/round.two/final/part-* \
    -output $HDFS_HOME/$1_data/round.three \
    -mapper ./round3.map.py -file ./round3.map.py \
    -jobconf stream.num.map.output.key.fields=2 \
    -partitioner org.apache.hadoop.mapred.lib.KeyFieldBasedPartitioner \
...
round_four ()
{
    ...
    #round 4: 
    $HADOOP_HOME/bin/hadoop jar $HADOOP_HOME/contrib/streaming/hadoop-streaming-1.2.2-SNAPSHOT.jar \
    -input /user/chongweishen/personal/ctr_sample_train/data_filt -input $HDFS_HOME/$1_data/round.three/part-* \
