...
-output ./training_data/round.one -mapper ./round1.map.py -reducer cat -file ./round1.map.py -file ./discretization.config -jobconf mapred.map.tasks=400 -jobconf mapred.reduce.tasks=400 \
